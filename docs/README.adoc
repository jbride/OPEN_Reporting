...
If Dashbuilder is unavailable (https://reporting.opentlc.com/dashbuilder/) one of the following methods will bring it back up.  The password for the jboss user is "jboss".
