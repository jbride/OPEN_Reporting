...
. Exerpience with use and administration of a MariaDB RBDMS.
...
. Experience developing _transactional_ applications using JDBC and the following patterns and archictures:
