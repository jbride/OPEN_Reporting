...
module add --name={{labs_demos_reporting_db_module_name}} --resources={{labs_demos_reporting_db_driver_jar_dir}}/{{labs_demos_reporting_db_driver_jar}} --dependencies=javax.api,javax.transaction.api
