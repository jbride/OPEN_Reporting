...
mysql -u root {{lms_reporting_db_name}} -e "load data local infile '{{database_update_script_dir}}/$1-db.csv' into table lms_reporting.RhpdsUsage fields terminated by ',' lines terminated by '\n';"
