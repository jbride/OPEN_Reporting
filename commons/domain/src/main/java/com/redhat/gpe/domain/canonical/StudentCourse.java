...
public class StudentCourse implements Serializable {
    ...
    public static final String WHERE_CLAUSE = "sc.StudentCourseID, sc.StudentID, sc.CourseID, sc.LanguageID, sc.AssessmentDate, sc.AssessmentResult, sc.AssessmentScore, sc.Processed";
